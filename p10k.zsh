# Generated by Powerlevel10k configuration wizard on 2022-05-08 at 02:28 CST.
...
() {
  ...
  # 如果prompt_char是最后一个段，则没有行结束符.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL=
  # 如果prompt_char是第一个段，则没有行引入器.
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_RAM_VISUAL_IDENTIFIER_EXPANSION='空闲内存'

  #####################################[ swap: used swap ]######################################
  # Swap color.
  typeset -g POWERLEVEL9K_SWAP_FOREGROUND=96
  # Custom icon.
  typeset -g POWERLEVEL9K_SWAP_VISUAL_IDENTIFIER_EXPANSION='已用内存'
  ...
  #如果跟踪的任务长度超过24个字符，截断并添加".."。
  #提示:要始终显示不截断的任务，请删除以下参数。
  #提示:当启用时间跟踪时，要隐藏任务名称并只显示图标，请设置
  #将下面参数的值设置为""。
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_PYENV_VISUAL_IDENTIFIER_EXPANSION='Git:'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_GOENV_VISUAL_IDENTIFIER_EXPANSION='Go:'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_NODENV_VISUAL_IDENTIFIER_EXPANSION='Node:'

  ##############[ nvm: node.js version from nvm (https://github.com/nvm-sh/nvm) ]###############
  # Nvm color.
  typeset -g POWERLEVEL9K_NVM_FOREGROUND=70
  # Custom icon.
  typeset -g POWERLEVEL9K_NVM_VISUAL_IDENTIFIER_EXPANSION='Node:'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_RBENV_VISUAL_IDENTIFIER_EXPANSION='Ruby:'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_RVM_VISUAL_IDENTIFIER_EXPANSION='Rvm:'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_PHPENV_VISUAL_IDENTIFIER_EXPANSION='PHPenv:'
